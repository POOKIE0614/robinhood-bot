...
class Config:
    ...
    def __init__(self):
        ...
        # CHAIN
        self.RPC_URL: str = os.getenv("RPC_URL", "https://rpc.mainnet.chain.robinhood.com")
        self.RPC_WSS_URL: str = os.getenv("RPC_WSS_URL", "wss://rpc.mainnet.chain.robinhood.com")
        self.FALLBACK_RPC_URL: str = os.getenv("FALLBACK_RPC_URL", "https://rpc.mainnet.chain.robinhood.com")
        self.CHAIN_ID: int = int(os.getenv("CHAIN_ID", "4663"))

        # MODE
        self.DRY_RUN: bool = str(os.getenv("DRY_RUN", "true")).lower() == "true"

        # STRATEGY & METHOD A: 40/40/20 FREE-RIDE MOONBAG LADDER
        ...
        # EXECUTION & ADAPTIVE TWO-TRACK TIMEOUTS
